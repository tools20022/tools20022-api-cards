		...
		mmObject_lazy.compareAndSet(null, new MMBusinessArea() {
			{
				...
				messageDefinition_lazy = () -> Arrays.asList(ATMDeviceControlV02.mmObject(), ATMDeviceReportV02.mmObject(), ATMKeyDownloadRequestV02.mmObject(), ATMKeyDownloadResponseV02.mmObject());
				code = "caam";
			}
		});
