...
import com.tools20022.repository.msg.AcceptorCompletionAdvice7;
...
@XmlType(name = "AcceptorCompletionAdviceV07", propOrder = {"header", "completionAdvice", "securityTrailer"})
public class AcceptorCompletionAdviceV07 {
	...
	protected AcceptorCompletionAdvice7 completionAdvice;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorCompletionAdviceV07.mmHeader, com.tools20022.repository.area.caaa.AcceptorCompletionAdviceV07.mmCompletionAdvice,
						com.tools20022.repository.area.caaa.AcceptorCompletionAdviceV07.mmSecurityTrailer);
			...
			public Class<?> getInstanceClass() {
				return AcceptorCompletionAdviceV07.class;
			}
		});
	...
	public AcceptorCompletionAdviceV07 setHeader(Header36 header) {
		this.header = Objects.requireNonNull(header);
		return this;
	}

	public AcceptorCompletionAdvice7 getCompletionAdvice() {
		return completionAdvice;
	}

	public AcceptorCompletionAdviceV07 setCompletionAdvice(AcceptorCompletionAdvice7 completionAdvice) {
	...
	public AcceptorCompletionAdviceV07 setSecurityTrailer(ContentInformationType16 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorCompletionAdviceV07 messageBody;
	}
}