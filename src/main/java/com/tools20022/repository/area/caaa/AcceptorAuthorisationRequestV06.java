...
public class AcceptorAuthorisationRequestV06 {
	...
	public void setAuthorisationRequest(AcceptorAuthorisationRequest6 authorisationRequest) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.001.06.06")
