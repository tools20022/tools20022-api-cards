		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(CardholderVerificationCapability2Code.mmObject(), CardholderVerificationCapability3Code.mmObject(), CardholderVerificationCapability4Code.mmObject());
