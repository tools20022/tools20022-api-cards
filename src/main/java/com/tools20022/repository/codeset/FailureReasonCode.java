		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(FailureReason3Code.mmObject(), FailureReason6Code.mmObject(), FailureReason5Code.mmObject(), FailureReason8Code.mmObject(), FailureReason7Code.mmObject());
