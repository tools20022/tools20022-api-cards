		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(ATMServiceType1Code.mmObject(), ATMServiceType3Code.mmObject(), ATMServiceType5Code.mmObject(), ATMServiceType6Code.mmObject(), ATMServiceType7Code.mmObject(),
						ATMServiceType8Code.mmObject(), ATMServiceType9Code.mmObject(), ATMServiceType10Code.mmObject());
