...
/**
 * Party which has delivered or declined the authorisation.
 * <p>
 * <strong>Class diagram</strong>
 * <p>
 * <embed name="AuthorisationEntity" src="doc-files/AuthorisationEntity.svg">
 * <p>
 ...
 * definition} = "Party which has delivered or declined the authorisation."</li>
 * </ul>
 */
public class AuthorisationEntity extends CardPaymentPartyRole {
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(CardPaymentTransactionResult3.mmAuthorisationEntity);
