...
public class Scheme {
	...
	public static final MMBusinessAttribute<Scheme, Max35Text> mmCode = new MMBusinessAttribute<Scheme, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialIdentificationSchemeName1Choice.mmCode, FinancialIdentificationSchemeName1Choice.mmProprietary, GenericIdentification4.mmIdentificationType,
					OrganisationIdentificationSchemeName1Choice.mmCode, OrganisationIdentificationSchemeName1Choice.mmProprietary, PersonIdentificationSchemeName1Choice.mmCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Scheme.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
