		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ATMTransactionAmounts8.mmObject(), ATMTransactionAmounts9.mmObject(), ATMTransactionAmounts6.mmObject(), ATMTransactionAmounts7.mmObject());
			}
