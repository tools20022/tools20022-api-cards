...
import com.tools20022.repository.msg.TerminalManagementDataSet22;
...
public class ManagementPlan6 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ManagementPlan6
	 * ManagementPlan6}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ManagementPlan6, Optional<GenericIdentification71>> mmPOIIdentification = new MMMessageAssociationEnd<ManagementPlan6, Optional<GenericIdentification71>>() {
		{
			businessElementTrace_lazy = () -> SystemIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ManagementPlan6.mmObject();
			isDerived = false;
			xmlTag = "POIId";
		...
		@Override
		public Optional<GenericIdentification71> getValue(ManagementPlan6 obj) {
			return obj.getPOIIdentification();
		}

		@Override
		public void setValue(ManagementPlan6 obj, Optional<GenericIdentification71> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ManagementPlan6, GenericIdentification71> mmTerminalManagerIdentification = new MMMessageAssociationEnd<ManagementPlan6, GenericIdentification71>() {
		{
			businessElementTrace_lazy = () -> SystemIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ManagementPlan6.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification71 getValue(ManagementPlan6 obj) {
			return obj.getTerminalManagerIdentification();
		}

		@Override
		public void setValue(ManagementPlan6 obj, GenericIdentification71 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ManagementPlan6, TerminalManagementDataSet22> mmDataSet = new MMMessageAssociationEnd<ManagementPlan6, TerminalManagementDataSet22>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> TerminalManagementDataSet22.mmObject();
		}

		@Override
		public TerminalManagementDataSet22 getValue(ManagementPlan6 obj) {
			return obj.getDataSet();
		}

		@Override
		public void setValue(ManagementPlan6 obj, TerminalManagementDataSet22 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ManagementPlan6.mmPOIIdentification, com.tools20022.repository.msg.ManagementPlan6.mmTerminalManagerIdentification,
						com.tools20022.repository.msg.ManagementPlan6.mmDataSet);
				messageBuildingBlock_lazy = () -> Arrays.asList(ManagementPlanReplacementV06.mmManagementPlan);
	...
	public ManagementPlan6 setPOIIdentification(GenericIdentification71 pOIIdentification) {
	...
	public ManagementPlan6 setTerminalManagerIdentification(GenericIdentification71 terminalManagerIdentification) {
	...
	public ManagementPlan6 setDataSet(TerminalManagementDataSet22 dataSet) {
