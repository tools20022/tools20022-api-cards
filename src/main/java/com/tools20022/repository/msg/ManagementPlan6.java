...
public class ManagementPlan6 {
	...
	public static final MMMessageAssociationEnd mmPOIIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ManagementPlan6.mmObject();
			isDerived = false;
			xmlTag = "POIId";
	...
	public static final MMMessageAssociationEnd mmDataSet = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TerminalManagementDataSet22.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ManagementPlan6.mmPOIIdentification, ManagementPlan6.mmTerminalManagerIdentification, ManagementPlan6.mmDataSet);
	...
	public void setDataSet(com.tools20022.repository.msg.TerminalManagementDataSet22 dataSet) {
