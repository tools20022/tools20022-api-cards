...
public class CardPaymentContext22 {
	...
	public static final MMMessageAssociationEnd mmPaymentContext = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CardPaymentContext22.mmObject();
			isDerived = false;
			xmlTag = "PmtCntxt";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentContext22.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentContext22.mmPaymentContext, CardPaymentContext22.mmSaleContext);
	...
	public void setPaymentContext(com.tools20022.repository.msg.PaymentContext22 paymentContext) {
