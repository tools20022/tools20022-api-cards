...
import com.tools20022.repository.area.caaa.AcceptorDiagnosticResponseV06;
...
@XmlType(name = "AcceptorDiagnosticResponse5", propOrder = {"environment", "tMSTrigger"})
public class AcceptorDiagnosticResponse5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptorDiagnosticResponse5.mmEnvironment, com.tools20022.repository.msg.AcceptorDiagnosticResponse5.mmTMSTrigger);
