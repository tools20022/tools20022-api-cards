...
public class ATMContext11 {
	...
	public static final MMMessageAttribute mmSessionReference = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ATMContext11.mmObject();
			isDerived = false;
			xmlTag = "SsnRef";
	...
	public static final MMMessageAssociationEnd mmService = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ATMService12.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ATMContext11.mmSessionReference, ATMContext11.mmService);
	...
	@XmlElement(name = "Svc")
	public ATMService12 getService() {
		return service;
	}

	public void setService(com.tools20022.repository.msg.ATMService12 service) {
