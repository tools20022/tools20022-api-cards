...
public class CardPaymentDataSetTransaction19 {
	...
	public static final MMMessageAttribute mmContext = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> com.tools20022.repository.msg.CardPaymentContext25.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction19.mmTransactionSequenceCounter, CardPaymentDataSetTransaction19.mmTraceability, CardPaymentDataSetTransaction19.mmEnvironment,
						CardPaymentDataSetTransaction19.mmContext, CardPaymentDataSetTransaction19.mmTransaction);
	...
	public void setContext(com.tools20022.repository.msg.CardPaymentContext25 context) {
